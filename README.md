...
**Nombre:** Gema Monserrat Ruiz Guereca
**Matrícula:** A01234810
...
- Email: A01234810@tec.mx
- GitHub: [@gemaruiz27](https://github.com/gemaruiz27)
...
```bash
git clone https://github.com/gemaruiz27/TC2004B-GemaR.git
cd TC2004B-GemaR
```
